...
if (isProd) {
  ...
  electron__WEBPACK_IMPORTED_MODULE_2__["app"].setPath("userData", "".concat(electron__WEBPACK_IMPORTED_MODULE_2__["app"].getPath("userData"), " (development)"));
}
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return electron__WEBPACK_IMPORTED_MODULE_2__["app"].whenReady();

        case 2:
          mainWindow = Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["createWindow"])("main", {
            width: 1000,
            height: 600
          });
        ...
        case 8:
          port = process.argv[2];
          _context.next = 11;
          return mainWindow.loadURL("http://localhost:".concat(port, "/"));
...
/* harmony default export */ __webpack_exports__["default"] = (function (windowName, options) {
  var key = "window-state";
  var name = "window-state-".concat(windowName);
  var store = new electron_store__WEBPACK_IMPORTED_MODULE_2___default.a({
    name: name
  });
  var defaultSize = {
    width: options.width,
  ...
  var resetToDefaults = function resetToDefaults() {
    var bounds = electron__WEBPACK_IMPORTED_MODULE_1__["screen"].getPrimaryDisplay().bounds;
  ...
  var ensureVisibleOnSomeDisplay = function ensureVisibleOnSomeDisplay(windowState) {
    var visible = electron__WEBPACK_IMPORTED_MODULE_1__["screen"].getAllDisplays().some(function (display) {
  ...
  var browserOptions = _objectSpread(_objectSpread(_objectSpread({}, options), state), {}, {
    webPreferences: _objectSpread({
      nodeIntegration: true
    }, options.webPreferences)
  });

  win = new electron__WEBPACK_IMPORTED_MODULE_1__["BrowserWindow"](browserOptions);
